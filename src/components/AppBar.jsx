...
const AppBar = () => {
  return (
    <View style={styles.container}>
      <AppBarTab to='/' icon='home-outline'> Home</AppBarTab>
      <AppBarTab to='/menu' icon='reader-outline'>Menu</AppBarTab>
      <AppBarTab to='/profile' icon='person-circle-outline'>Profile</AppBarTab>
    </View>
  );
};
